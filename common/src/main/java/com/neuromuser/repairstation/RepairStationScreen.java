...
public class RepairStationScreen extends AbstractContainerScreen<RepairStationScreenHandler> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        if (menu.isRepairing()) {
            ...
            guiGraphics.blit(RenderType::guiTextured, TEXTURE, x + 56, y + 36 + 12 - fuelProgress,
                    176, 12 - fuelProgress, 14, fuelProgress + 1, 256, 256);
        }

        int repairProgress = menu.getRepairProgress();
        guiGraphics.blit(RenderType::guiTextured, TEXTURE, x + 79, y + 34, 176, 14, repairProgress + 1, 16, 256, 256);
    }
